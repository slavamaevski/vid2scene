...
export class SceneAlignerControls {
  ...
  public enable() {
    ...
    // These will only activate when clicking on the handles themselves
    if (this.app.mouse) {
  ...
  public undo() {
    ...
    if (this.gsEntity && this.originalScenePosition && this.originalSceneRotation) {
      console.log('Undoing to:', this.originalScenePosition, this.originalSceneRotation);
      ...
      console.log('Undo failed - missing data:', {
        gsEntity: !!this.gsEntity,
        originalScenePosition: !!this.originalScenePosition,
        originalSceneRotation: !!this.originalSceneRotation
      });
    }
  }
  ...
  public apply() {
    ...
    if (this.gsEntity) {
      this.originalScenePosition = this.gsEntity.getPosition().clone();
      this.originalSceneRotation = this.gsEntity.getRotation().clone();
      console.log('Applied new baseline:', this.originalScenePosition, this.originalSceneRotation);
    }
  }
